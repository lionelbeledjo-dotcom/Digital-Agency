...
import { LayoutDashboard, Users, GraduationCap, Wallet, CreditCard, Mail, FileText, Settings, ShieldCheck, LogOut, Image, Newspaper } from "lucide-react";
...
const items = [
  ...
  { to: "/admin/blog", label: "Blog", Icon: Newspaper, exact: undefined as boolean | undefined },
