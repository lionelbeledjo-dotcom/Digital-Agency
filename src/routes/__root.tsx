...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "LB Digital · Apprends. Partage. Gagne." },
      ...
      { name: "twitter:title", content: "LB Digital · Apprends. Partage. Gagne." },
      { name: "twitter:description", content: "Plateforme de formation IA et marketing digital avec affiliation pour l'Afrique francophone." },
