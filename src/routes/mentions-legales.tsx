...
export const Route = createFileRoute("/mentions-legales")({
  head: () => ({ meta: [{ title: "Mentions légales · LB Digital" }] }),
  component: () => (
    <PublicLayout>
      <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-8 space-y-5 text-sm text-muted-foreground leading-relaxed">
          <section><h2 className="text-lg font-semibold text-foreground">Éditeur</h2><p>LB Digital · Plateforme de formation et affiliation. Siège : Abidjan, Côte d'Ivoire.</p></section>
          ...
          <section><h2 className="text-lg font-semibold text-foreground">Propriété intellectuelle</h2><p>L'ensemble des contenus, formations, textes, vidéos et visuels est la propriété exclusive de LB Digital.</p></section>
