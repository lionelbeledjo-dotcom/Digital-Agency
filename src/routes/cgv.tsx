...
export const Route = createFileRoute("/cgv")({
  head: () => ({ meta: [{ title: "CGV · LB Digital" }] }),
  component: () => (
    <PublicLayout>
      <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-8 space-y-5 text-sm text-muted-foreground leading-relaxed">
          <section><h2 className="text-lg font-semibold text-foreground">Objet</h2><p>Les présentes CGV régissent l'utilisation de la plateforme LB Digital et la souscription aux abonnements Starter, Club IA et Pro Creator.</p></section>
